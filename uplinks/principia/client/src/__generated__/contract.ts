...
export interface PrincipiaAnalysis
{
	...
	*/
	orbit?: PrincipiaOrbitAnalysis | null;
	/**
	...
	*/
	coasts?: PrincipiaCoastAnalysis[] | null;
}
/**
...
export interface PrincipiaCoastAnalysis
{
	...
	* analyse from.
	*/
	analysis?: PrincipiaOrbitAnalysis | null;
}
/**
...
export interface PrincipiaOrbitAnalysis
{
	...
	*/
	ascendingCrossingDegrees?: PrincipiaAngleInterval | null;
	/** The same band for the southbound crossing. */
	descendingCrossingDegrees?: PrincipiaAngleInterval | null;
	/**
	...
	*/
	ascendingNodeSolarTimeDegrees?: PrincipiaAngleInterval | null;
	/** The same band at the southbound node. */
	descendingNodeSolarTimeDegrees?: PrincipiaAngleInterval | null;
	...
	meanLongitudeOfAscendingNodeDegrees?: PrincipiaAngleInterval | null;
	/**
	* Where periapsis sits within the plane. A band whose width is the apsidal
	* drift over the window.
	*/
	meanArgumentOfPeriapsisDegrees?: PrincipiaAngleInterval | null;
	/**
	* Low point above the surface, as a range. Altitude, not distance: the
	* primary's radius is already taken off.
	*/
	meanPeriapsisAltitudeMetres?: PrincipiaLengthInterval | null;
	/** High point above the surface, as a range. */
	meanApoapsisAltitudeMetres?: PrincipiaLengthInterval | null;
	/**
...
export interface PrincipiaSettings
{
	...
	*/
	burnFrames?: PrincipiaReferenceFrame[] | null;
	/**
	...
	* vessel.
	*/
	targetCelestialBody?: string | null;
	/**
	...
	*/
	predictionVesselId?: string | null;
	/**
...
export interface PrincipiaPlan
{
	...
	*/
	writeSurface?: PrincipiaWriteSurface | null;
	...
	*/
	integrator?: PrincipiaPlanIntegrator | null;
	/** The committed burns, in plan order. */
	burns?: PrincipiaPlannedBurn[] | null;
}
/**
