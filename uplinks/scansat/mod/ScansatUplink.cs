...
namespace Gonogo.ScansatUplink
{
    ...
    public sealed class ScansatUplink : ISitrepUplink
    {
        ...
        public UplinkManifest Manifest { get; } = new UplinkManifest
        {
            ...
            // Both values are generated by tooling/bake-client-source.mjs, Url
            // from uplink.json and DevPath from the build that produced the DLL.
            // DevPath is null unless a dev build supplied one, because the loader
            // PREFERS it and a released DLL carrying one points every user at a
